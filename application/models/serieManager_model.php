...
class SerieManager_model extends CI_Model
{
    ...
    {
        $this->db->select("serie_name, serie_summary, serie_year, serie_nbseasons, serie_age, serie_status, cat_lib AS serie_catname, src_lib AS serie_srcname, user_pseudo AS serie_creatorname");
